...
namespace Matrix.Head
{

    public sealed partial class MainPage : Page
    {
        private AppServiceConnection LEDService { get; } = new AppServiceConnection();

        private string MatrixLEDServiceName { get; } = "MatrixLEDService";
        ...
        private async void SetupAppService()
        {
            ...
            var listing = await AppServiceCatalog.FindAppServiceProvidersAsync(MatrixLEDServiceName);
            var packageName = "";
            ...
            else
            {
                ...
                LEDService.RequestReceived += PerimeterBreachService_RequestReceived;
            }
        }
        ...
        private async void btnCommand_Click(object sender, RoutedEventArgs e)
        {
            ...
            var response = await LEDService.SendMessageAsync(message);
            var result = "";
